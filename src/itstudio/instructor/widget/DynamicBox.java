...
public class DynamicBox {
    ...
    private final String[] mSupportedAbsListViews = new String[]{"xlistview","listview","gridview","expandablelistView"};
    private final String[] mSupportedViews = new String[]{"linearlayout","relativelayout","scrollview","framelayout"};
    ...
    public DynamicBox(Context context, View targetView){
        ...
        if(Arrays.asList(mSupportedAbsListViews).contains(type)){
        	System.out.println("xlistview".equals(type));
    ...
    //
    public void setDefaultLoadView(){
    	 View emptyCollectionView = this.mInflater.inflate(R.layout.music_not_found, null, false);
    	 addCustomView(emptyCollectionView,"page_not_found");
    	 setLoadingMessage("");
    }
/*    public void setDefaultLoadView(String str){
   	 View emptyCollectionView = this.mInflater.inflate(R.layout.music_not_found, null, false);
   	 addCustomView(emptyCollectionView,str);
