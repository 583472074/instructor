 ...
 * Todd Davies' Progress Wheel https://github.com/Todd-Davies/MaterProgressWheel
 *
 ...
 */
public class MaterProgressWheel extends View {
	
    private static final String TAG = MaterProgressWheel.class.getSimpleName();
    ...
    /**
     * The constructor for the MaterProgressWheel
     *
     * @param context
     * @param attrs
     */
    public MaterProgressWheel(Context context, AttributeSet attrs) {
        super(context, attrs);

        parseAttributes(context.obtainStyledAttributes(attrs,
                R.styleable.MaterProgressWheel));
    }
     ...
     * @param context
     */
    public MaterProgressWheel(Context context) {
        super(context);
    }
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius = (int) a.getDimension(R.styleable.MaterProgressWheel_circleRadius, PixelUtil.dp2px(80));

        fillRadius = a.getBoolean(R.styleable.MaterProgressWheel_fillRadius, false);

        barWidth = (int) a.getDimension(R.styleable.MaterProgressWheel_materbarWidth, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.MaterProgressWheel_materrimWidth, rimWidth);

        float baseSpinSpeed = a.getFloat(R.styleable.MaterProgressWheel_materspinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime = a.getInt(R.styleable.MaterProgressWheel_barSpinCycleTime, (int) barSpinCycleTime);

        barColor = a.getColor(R.styleable.MaterProgressWheel_materbarColor, barColor);

        rimColor = a.getColor(R.styleable.MaterProgressWheel_materrimColor, rimColor);

        if (a.getBoolean(R.styleable.MaterProgressWheel_progressIndeterminate, false)) {
            spin();
        }
